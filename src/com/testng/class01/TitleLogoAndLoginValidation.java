...
//		sendText(username, "Admin");
		...
		String expectedLogin="Welcome Admin";
		String actualLoging=welcom.getText();
		if(expectedLogin.equals(actualLoging)) {
			System.out.println("ValidationLogin passed");
		}else {
			System.out.println("ValidationLogin failed");
		}
